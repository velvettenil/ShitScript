...
local function fartsakenLoad()
	...
	setclipboard("https://linkunlocker.com/yuruyuri-Strawberry")

	local GUI = Rayfield:CreateWindow({
		Name = "Yuruyuri",
		Theme = "Default",
		LoadingTitle = "Yuruyuri! 🍓",
		LoadingSubtitle = "Welcome to Yuruyuri! 🍓",
		Icon = "microwave",
		...
		KeySystem = true,
		KeySettings = {
			Title = "Yuruyuri Key System",
			Subtitle = "Panic! Strawberry!",
			Note = "Strawberry Key Copied 🍓",
			FileName = "yuruyuriKey",
			SaveKey = true,
			GrabKeyFromSite = false,
			Key = { "Panic! Strawberry!" },
		},
	})
